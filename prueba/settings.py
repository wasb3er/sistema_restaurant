...
SECRET_KEY = 'django-insecure-(wofl3&z-b2jlyu7iyha=6*_-b3+t5j@*pac2gm9!&y&esg$e='
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "templates"],   #para llamar a los .html
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
STATIC_URL = "static/"
STATICFILES_DIRS = [
    BASE_DIR / "static",   #dónde están CSS y JS
]
